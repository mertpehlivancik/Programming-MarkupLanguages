...
static int decrypt(const char *target_file, const char *source_file,
	...
	do {
		...
		if (tag == crypto_secretstream_xchacha20poly1305_TAG_FINAL && !eof) {
			goto ret;
			/*	premature	end	(end	of	file	reached	before	the	end	of	the	stre
			 am)	*/
		}
		fwrite(buf_out, 1, (size_t) out_len, fp_t);
	} while (!eof);
...
int main(void) {
	...
	const char* target_file =
			"/home/mert/git/C/LibsodiumLibrary/FileCryptology/src/mert2.txt";
	const char* source_file =
			"/home/mert/git/C/LibsodiumLibrary/FileCryptology/src/mert.txt";
	if(encrypt(target_file, source_file, k) != 0){
		return 1;
	}
	const char* target_file2 =
			"/home/mert/git/C/LibsodiumLibrary/FileCryptology/src/mert3.txt";
	const char* source_file2 =
			"/home/mert/git/C/LibsodiumLibrary/FileCryptology/src/mert2.txt";
	if(decrypt(target_file2, source_file2, k) != 0){
		return 1;
	}
	return 0;
}
