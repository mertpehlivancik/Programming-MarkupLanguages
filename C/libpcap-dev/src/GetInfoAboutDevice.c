#include <stdio.h>
#include <pcap.h>                        /*HATIRLATMA : Her şeyi comment'e almanın yolu CTRL+7'dir*/
#include <arpa/inet.h>
#include <string.h>
...
//    char ip[13];
//    char subnet_mask[13];
//    bpf_u_int32 ip_raw; /* IP address as integer */                         /* bpf_u_int32 --> 32 unsigned bits*/
...
//    strcpy(ip, inet_ntoa(address));                  /*inet_ntoa fonksiyonu ip adresini human-readable şekline çeviriyor */
//    if (ip == NULL) {
